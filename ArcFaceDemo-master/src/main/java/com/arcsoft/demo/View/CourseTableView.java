...
public class CourseTableView extends RelativeLayout {
    // 课程格子的背景图
    private static final int[] COURSE_BG = {R.drawable.course_info_red, R.drawable.course_info_green,
            R.drawable.course_info_light_grey, R.drawable.course_info_blue, R.drawable.course_info_yellow,
            };
...
//    @Override
//    public boolean onTouchEvent(MotionEvent event) {//长按事件
//        if(MotionEvent.ACTION_UP == event.getAction()){
//            TouchNum = 0;
//        }else{
//            TouchNum  += getWindowAttachCount();
//            if ((TouchNum == 50)) {
//                clearViewsIfNeeded();
//            }
//        }
...
//    }
    ...
    private void updateCourseViews() {
        ...
        for (final Course c : coursesData) {
            ...
            Random r=new Random();
            int t=r.nextInt(5);
            tv.setBackgroundResource(COURSE_BG[t]);
