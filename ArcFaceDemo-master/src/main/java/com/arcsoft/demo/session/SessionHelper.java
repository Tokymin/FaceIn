package com.arcsoft.demo.session;
...
import com.arcsoft.demo.contact.activity.RobotProfileActivity;
import com.arcsoft.demo.contact.activity.UserProfileActivity;
import com.arcsoft.demo.session.action.AVChatAction;
import com.arcsoft.demo.session.action.FileAction;
import com.arcsoft.demo.session.action.GuessAction;
import com.arcsoft.demo.session.action.RTSAction;
import com.arcsoft.demo.session.action.SnapChatAction;
import com.arcsoft.demo.session.action.TeamAVChatAction;
import com.arcsoft.demo.session.action.TipAction;
import com.arcsoft.demo.session.activity.MessageHistoryActivity;
import com.arcsoft.demo.session.activity.MessageInfoActivity;
import com.arcsoft.demo.session.extension.CustomAttachParser;
import com.arcsoft.demo.session.extension.CustomAttachment;
import com.arcsoft.demo.session.extension.GuessAttachment;
import com.arcsoft.demo.session.extension.RTSAttachment;
import com.arcsoft.demo.session.extension.RedPacketAttachment;
import com.arcsoft.demo.session.extension.SnapChatAttachment;
import com.arcsoft.demo.session.extension.StickerAttachment;
import com.arcsoft.demo.session.search.SearchMessageActivity;
import com.arcsoft.demo.session.viewholder.MsgViewHolderAVChat;
import com.arcsoft.demo.session.viewholder.MsgViewHolderDefCustom;
import com.arcsoft.demo.session.viewholder.MsgViewHolderFile;
import com.arcsoft.demo.session.viewholder.MsgViewHolderGuess;
import com.arcsoft.demo.session.viewholder.MsgViewHolderRTS;
import com.arcsoft.demo.session.viewholder.MsgViewHolderSnapChat;
import com.arcsoft.demo.session.viewholder.MsgViewHolderSticker;
import com.arcsoft.demo.session.viewholder.MsgViewHolderTip;
