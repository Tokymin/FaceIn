...
import com.arcsoft.demo.contact.activity.AddFriendActivity;
import com.arcsoft.demo.contact.activity.UserProfileSettingActivity;
import com.arcsoft.demo.fragment.HomeNewsFragment;
import com.arcsoft.demo.fragment.TableFragment;
import com.arcsoft.demo.main.activity.SettingsActivity;
import com.arcsoft.demo.main.model.Extras;
...
public class SlindingActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void setFramet(int i){
        if(i==1){
//            toolbar.setVisibility(View.GONE);
//            setIndexSelected(1);
            RadioButton radioButton=findViewById(R.id.rb_table);
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch (i) {
                    ...
                    case R.id.rb_communi:
                        Intent intent = new Intent(SlindingActivity.this, com.arcsoft.demo.main.activity.MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_sys) {//要写一个扫一扫界面
            Toast.makeText(this, "sorry,此功能还在开发中", Toast.LENGTH_SHORT).show();
            return true;
        }
        if (id == R.id.action_tj) {//添加个啥？？
            AddFriendActivity.start(SlindingActivity.this);
            return true;
        }
        if(id==R.id.setting){
            startActivity(new Intent(SlindingActivity.this, SettingsActivity.class));
            return true;
        }
...
//            startActivity(i);
            ...
            Toast.makeText(this, "sorry，此功能正在开发中...", Toast.LENGTH_SHORT).show();
