...
import com.arcsoft.sdk_demo.common.ui.viewpager.FadeInOutPageTransformer;
import com.arcsoft.sdk_demo.common.ui.viewpager.PagerSlidingTabStrip;
import com.arcsoft.sdk_demo.main.adapter.MainTabPagerAdapter;
import com.arcsoft.sdk_demo.main.helper.SystemMessageUnreadManager;
import com.arcsoft.sdk_demo.main.model.MainTab;
import com.arcsoft.sdk_demo.main.reminder.ReminderItem;
                ...
                new DropCover.IDropCompletedListener() {
                    ...
                    public void onCompleted(Object id, boolean explosive) {
                        ...
                        if (id instanceof RecentContact) {
                            ...
                            LogUtil.i("HomeNewsFragment", "clearUnreadCount, sessionId=" + r.getContactId());
                        } else if (id instanceof String) {
                            if (((String) id).contentEquals("0")) {
                                NIMClient.getService(MsgService.class).clearAllUnreadCount();
                                LogUtil.i("HomeNewsFragment", "clearAllUnreadCount");
                            } else if (((String) id).contentEquals("1")) {
                                NIMClient.getService(SystemMessageService.class).resetSystemMessageUnreadCount();
                                LogUtil.i("HomeNewsFragment", "clearAllSystemUnreadCount");
                            }
                        }
                    }
                });
