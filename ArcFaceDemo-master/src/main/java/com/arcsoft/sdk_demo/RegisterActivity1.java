...
import com.arcsoft.sdk_demo.contact.ContactHttpClient;
...
public class RegisterActivity1 extends Activity {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 1:
                                ...
                                ((MyApplication) (RegisterActivity1.this.getApplicationContext())).setCaptureImage(uri);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {// 学长改
        ...
        if (requestCode == REQUEST_CODE_IMAGE_CAMERA && resultCode == RESULT_OK) {
            Uri mPath = ((MyApplication) (RegisterActivity1.this.getApplicationContext())).getCaptureImage();
