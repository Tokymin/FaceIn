package com.arcsoft.sdk_demo.session;
...
import com.arcsoft.sdk_demo.contact.activity.RobotProfileActivity;
import com.arcsoft.sdk_demo.contact.activity.UserProfileActivity;
import com.arcsoft.sdk_demo.session.action.AVChatAction;
import com.arcsoft.sdk_demo.session.action.FileAction;
import com.arcsoft.sdk_demo.session.action.GuessAction;
import com.arcsoft.sdk_demo.session.action.RTSAction;
import com.arcsoft.sdk_demo.session.action.SnapChatAction;
import com.arcsoft.sdk_demo.session.action.TeamAVChatAction;
import com.arcsoft.sdk_demo.session.action.TipAction;
import com.arcsoft.sdk_demo.session.activity.MessageHistoryActivity;
import com.arcsoft.sdk_demo.session.activity.MessageInfoActivity;
import com.arcsoft.sdk_demo.session.extension.CustomAttachParser;
import com.arcsoft.sdk_demo.session.extension.CustomAttachment;
import com.arcsoft.sdk_demo.session.extension.GuessAttachment;
import com.arcsoft.sdk_demo.session.extension.RTSAttachment;
import com.arcsoft.sdk_demo.session.extension.RedPacketAttachment;
import com.arcsoft.sdk_demo.session.extension.SnapChatAttachment;
import com.arcsoft.sdk_demo.session.extension.StickerAttachment;
import com.arcsoft.sdk_demo.session.search.SearchMessageActivity;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderAVChat;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderDefCustom;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderFile;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderGuess;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderRTS;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderSnapChat;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderSticker;
import com.arcsoft.sdk_demo.session.viewholder.MsgViewHolderTip;
